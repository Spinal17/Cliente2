...
print(HacerMatrizN('https://github.com/ingjcgomez/Ejercico2/blob/main/titanic.csv?raw=true'))

MostrarInformacion(Cargardatos('https://github.com/ingjcgomez/Ejercico2/blob/main/titanic.csv?raw=true'))
